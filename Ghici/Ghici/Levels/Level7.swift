    ...
    var body: some View {
        VStack{
            ...
            HStack{
                ...
                Text("\(symbol[5])")
                    .padding(20)
                    .background((symbol[5] == "0") ? Color.green.opacity(0.7) :  Color.gray.opacity(0.2))
                    .foregroundStyle(.white)
                    .font(.title)
                    .onTapGesture {
                        withAnimation(.bouncy){
            ...
            HStack{
                ...
                Text("\(symbol[10])")
                    .padding(20)
                    .background((symbol[10] == "0") ? Color.green.opacity(0.7) :  Color.gray.opacity(0.2))
                    .foregroundStyle(.white)
                    .font(.title)
                    .onTapGesture {
                        withAnimation(.bouncy){
            ...
            HStack{
                Text("\(symbol[12])")
                    .padding(20)
                    .background((symbol[12] == "X") ? Color.red.opacity(0.7) :  Color.gray.opacity(0.2))
                    .foregroundStyle(.white)
                    .font(.title)
                    .onTapGesture {
                        withAnimation(.bouncy){
                ...
                Text("\(symbol[15])")
                    .padding(20)
                    .background((symbol[15] == "0") ? Color.green.opacity(0.7) :  Color.gray.opacity(0.2))
                    .foregroundStyle(.white)
                    .font(.title)
                    .onTapGesture {
                        withAnimation(.bouncy){
            ...
            VStack{
                Text("\(mesaj)")
                    ...
                    .onChange(of: count){
                        if(symbol[0]=="0")&&(symbol[5]=="0")&&(symbol[10]=="0")&&(symbol[15]=="0"){
                            mesaj = "Well done!"
                        }else{
                            if(count <= 0){
                                mesaj = "Try again"
